...
HorizontalAirtable.defaultProps = {
    width: 810,
    height: 375,
    onItemTapped: () => {},
}
...
export function HorizontalAirtable(props: Props) {
        ...
        return (
            <ComponentInstructions>
                ...
                <ol style={{ lineHeight: 2 }}>
                    ...
                    <li>
                        <b>
                            {isAirtableUrl(props.url) ? "✅" : ""} Add Airtable
                            URL
                        </b>
                        : <br />
                        Enter your Airtable API url on the component’s
                    ...
                    <li>
                        <b>
                            {isValidComponent(props.component) ? "✅" : ""}{" "}
...
StackControls.direction.defaultValue = "horizontal"

//@ts-ignore
const ScrollControls = { ...Scroll.propertyControls }
ScrollControls.direction.defaultValue = "horizontal"

addPropertyControls(HorizontalAirtable, {
