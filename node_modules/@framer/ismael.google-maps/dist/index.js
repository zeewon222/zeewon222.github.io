...
//# framerSourceMap=
...
function Map({ lat, lon, zoom }) {
    ...
    return (React.createElement("iframe", { style: style, src: `http://maps.google.com/maps?q=${lat},${lon}&z=${zoom}&output=embed` }));
}
exports.Map = Map;
Map.defaultProps = {
    lat: -34.903667,
...
framer_1.addPropertyControls(Map, {
    lat: {
    ...
    zoom: { type: framer_1.ControlType.Number, step: 1, min: 0, max: 25, title: "Zoom" },
});
exports.__info__ = [{ "name": "Map", "children": false, "type": "component" }];
...
module.exports = JSON.parse("{\"main\":\"dist/index.js\",\"license\":\"MIT\",\"devDependencies\":{\"@types/react\":\"^16.8\"},\"peerDependencies\":{\"framer\":\"^1.0\",\"react\":\"^16.8\"},\"framer\":{\"id\":\"cf50f147-14e5-4f9a-ab08-afe80b6dcb35\",\"displayName\":\"Google Maps\"},\"author\":\"Ismael Martínez\",\"name\":\"@framer/ismael.google-maps\",\"version\":\"2.1.0\"}");
